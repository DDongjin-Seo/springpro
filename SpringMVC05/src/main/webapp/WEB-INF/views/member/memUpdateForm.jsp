...
<body>
	<div class="container">
		...
		<div class="panel panel-default">
							...
							<td colspan="2">
								<div class="form-group"
									...
									<div class="btn-group" data-toggle="buttons">
										<label
											class="btn btn-primary <c:if test="${memGender eq '남자'}">active</c:if>">
											<input id="memGender" name="memGender" type="radio"
											autocomplete="off" value="남자" checked
											<c:if test="${memGender eq '남자'}">checked</c:if> />남자
										</label> <label
											class="btn btn-primary <c:if test="${memGender eq '여자'}">active</c:if>">
											<input id="memGender" name="memGender" type="radio"
											autocomplete="off" value="여자"
											<c:if test="${memGender eq '여자'}">checked</c:if> />여자
										</label>
									</div>
								</div>
							</td>
			...
			<div class="panel-footer">스프1탄_인프런(서동진)</div>
		</div>
	</div>
</body>
</html>
