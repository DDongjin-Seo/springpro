...
<body>
	<div class="container">
		...
		<div class="panel panel-default">
			...
			<div class="panel-body" id="wform" style="display: none">
				<form id="frm">
					...
					<table class="table">
						...
						<tr>
							<td>내용</td>
							<td><textarea rows="7" id="content" name="content"
									class="form-control"></textarea></td>
						</tr>
						<tr>
							<td>작성자</td>
							<td><input type="text" id="writer" name="writer"
								class="form-control" value="${mvo.memName}" readonly /></td>
						</tr>
						<tr>
			...
			<div class="panel-footer">인프런_스프1탄_서동진</div>
		</div>
	</div>
</body>
</html>
