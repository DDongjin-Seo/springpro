...
$(document).ready(function(){
	...
	function registerCheck() {
		var memID = $("#memID").val(); // jQuery로 ID 가져오기 수정
		$.ajax({
					...
					<table class="table table-bordered"
							...
							<td colspan="2">
								<div class="form-group"
									...
									<div class="btn-group" data-toggle="buttons">
										...
										</label> <label class="btn btn-primary"> <input id="memGender"
											name="memGender" type="radio" autocomplete="off" value="여자" />여자
										</label>
									</div>
								</div>
							</td>
						...
						<tr>
							<td colspan="3" style="text-align: left;"><span
								...
								class="btn btn-primary btn-sm pull-right" value="등록" onclick="goInsert()"/></td>
						</tr>
					</table>
				</form>
			</div>
